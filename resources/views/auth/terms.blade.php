...
@section('content')
  ...
  <div class="register-box" style="width: 750px;">
    <div class="register-logo">
      <a href="/login"><b>Police</b> Computer</a>
    </div>
    ...
    <div class="register-box-body">
      ...
      <p>We implement a variety of security measures when a user enters, submits, or accesses their information to maintain the safety of your personal information.
      ...
      <p>If you disable cookies, some features will be disabled It will turn off some of the features that make your site experience more efficient and some of our services will not function properly.</p>
      ...
      <h3>Google</h3>
      <p>Google's advertising requirements can be summed up by Google's Advertising Principles. They are put in place to provide a positive experience for users. <a href="https://support.google.com/adwordspolicy/answer/1316548?hl=en">https://support.google.com/adwordspolicy/answer/1316548?hl=en</a>
      <p>Google, as a third party vendor, uses cookies to serve ads on our site. Google's use of the DART cookie enables it to serve ads to our users based on their visit to our site and other sites on the Internet. Users may opt out of the use of the DART cookie by visiting the Google ad and content network privacy policy.
      ...
      <p>If at any time you would like to unsubscribe from receiving future emails, you can use the link at the bottom of each marketing email</p>
      <h3>Contacting Us</h3>
      <p>If there are any questions regarding this privacy policy you may contact us using the information below.</p>
      http://localhost:8888/<br>
      Maidstone<br>
      London, Kent ME19 6BD<br>
      United Kindom<br>
      support@localhost:8888/<br><br>

      <b>Last Edited on 2015-09-02</b>
      <a href="/register">Got it, Take me back</a>
    </div>{{-- /.form-box --}}
  </div>{{-- /.register-box --}}
@endsection